...
**OOP School Library** This project build a school library using object oriented programming. users can add new students, teachers or books and save records of those who borrowed a given book<a name="built-with"></a>
...
- Clone this repo <https://github.com/shaaibu7/OOP-School-Library>

  ```bash
  git clone https://github.com/shaaibu7/OOP-School-Library
  ```
...
- [ ] **Add graphical UI for application**
- [ ] **Track the catalogue of books for specific domain**
